...
export const protocols: Protocol[] = [
    {
        ...
        messages: [
            ...
            { day: 24, title: 'Reconhecendo Gatilhos', message: "Qual situação te faz sair do plano? Tédio? Cansaço? Ansiedade? Identificar seus gatilhos é o primeiro passo para criar um plano de ação antes que eles apareçam." },
